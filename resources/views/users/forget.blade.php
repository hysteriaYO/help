        ...
        <div class="container">
            <div class="login">
                <form action="" method="POST">
                    {{ csrf_field() }}
                    <h3 class="system">找回密码</h3>
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon">
                                <span class="glyphicon glyphicon-user"></span>
                            </div>
                            <input class="form-control username all" placeholder="用户名" type="text" name="username">
                        </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="form-control btn btn-r">找回</button>
                    </div>
                    <div class="form-group">
                        想起密码?<a href="login" title="立即注册">立即登录</a>
                    </div>
